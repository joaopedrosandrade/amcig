...
<main class="app-wrapper">
    <div class="container-fluid">
        <div class="main-breadcrumb d-flex align-items-center my-3 position-relative">
            <h2 class="breadcrumb-title mb-0 flex-grow-1 fs-14">Editar Parceria</h2>
            <div class="flex-shrink-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-end mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.parcerias.index') }}">Parcerias</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Editar Parceria</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form id="parceriaForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nome_empresa" name="nome_empresa" value="{{ $parceria->nome_empresa }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="categoria" name="categoria" required>
                                            ...
                                            @foreach($categorias as $key => $nome)
                                                <option value="{{ $key }}" {{ $parceria->categoria == $key ? 'selected' : '' }}>{{ $nome }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Descrição breve da empresa e serviços oferecidos...">{{ $parceria->descricao }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="telefone" name="telefone" placeholder="(00) 0000-0000" value="{{ $parceria->telefone }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="email" class="form-label">E-mail</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="contato@empresa.com" value="{{ $parceria->email }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="website" class="form-label">Website</label>
                                        <input type="url" class="form-control" id="website" name="website" placeholder="https://www.empresa.com" value="{{ $parceria->website }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Endereço completo da empresa" value="{{ $parceria->endereco }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if($parceria->logo)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/logos/' . $parceria->logo) }}" alt="Logo atual" style="max-width: 200px; max-height: 200px; border-radius: 8px;" class="border">
                                        <div class="form-text">Logo atual</div>
                                    </div>
                                @endif
                                <input type="file" class="form-control" id="logo" name="logo" accept="image/jpeg,image/jpg,image/png">
                                <div class="form-text">Formatos aceitos: JPG, JPEG, PNG. Tamanho máximo: 2MB. Deixe em branco para manter a logo atual.</div>
                                <div id="logo-preview" class="mt-2" style="display: none;">
                                    ...
                                    <div class="form-text">Nova logo</div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="tipo_desconto" name="tipo_desconto" required>
                                            ...
                                            @foreach($tiposDesconto as $key => $nome)
                                                <option value="{{ $key }}" {{ $parceria->tipo_desconto == $key ? 'selected' : '' }}>{{ $nome }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="valor_desconto" name="valor_desconto" 
                                               step="0.01" min="0" required placeholder="0.00" value="{{ $parceria->valor_desconto }}">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="valor_minimo_pedido" name="valor_minimo_pedido" 
                                               step="0.01" min="0" placeholder="0.00" value="{{ $parceria->valor_minimo_pedido }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="condicoes_desconto" name="condicoes_desconto" rows="2" 
                                          placeholder="Condições especiais do desconto (ex: Válido apenas aos sábados, Não acumula com outras promoções...)">{{ $parceria->condicoes_desconto }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="ordem" name="ordem" min="0" value="{{ $parceria->ordem }}">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <div class="form-check mt-4">
                                            <input class="form-check-input" type="checkbox" id="ativo" name="ativo" value="1" {{ $parceria->ativo ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <div class="form-check mt-4">
                                            <input class="form-check-input" type="checkbox" id="destaque" name="destaque" value="1" {{ $parceria->destaque ? 'checked' : '' }}>
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="ri-save-line me-1"></i>Atualizar Parceria
                                </button>
                            </div>
                        </form>
                    </div>
...
$(document).ready(function() {
    ...
    $('#parceriaForm').on('submit', function(e) {
        ...
        $btn.prop('disabled', true).html('<i class="ri-loader-4-line ri-spin me-1"></i>Atualizando...');
        
        const formData = new FormData(this);
        
        console.log('Enviando dados:', formData);
        console.log('URL:', '{{ route("admin.parcerias.update", $parceria->id) }}');
        console.log('CSRF Token:', $('meta[name="csrf-token"]').attr('content'));
        
        $.ajax({
            url: '{{ route("admin.parcerias.update", $parceria->id) }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    toastr.error(response.message || 'Erro ao atualizar parceria');
                }
            },
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    const errorMsg = xhr.responseJSON?.message || 'Erro ao atualizar parceria';
