...
<head>
  <meta charset="utf-8" />
  <title>Login Administrador - AMCIG</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
  <meta content="Login de Administradores AMCIG" name="description" />
  ...
  <div class="row justify-content-center align-items-center min-vh-100 pt-10 pb-10">
    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
      <div class="card mx-xxl-8 shadow-none">
            ...
            <h3 class="fw-medium text-center">Área do Administrador</h3>
            
            <div class="text-center mb-4">
              <img src="{{asset('assets/images/logos.png')}}" alt="Logo AMCIG" class="img-fluid" style="max-height: 100px;">
            </div>
       
            <p class="mb-8 text-muted text-center">Faça o seu login de administrador abaixo</p>
          ...
          <form method="POST" action="{{ route('admin.login.submit') }}" id="adminLoginForm">
            ...
            <div>
              <button type="submit" class="btn btn-primary w-100 mb-4" id="loginBtn">Acessar como Administrador</button>
